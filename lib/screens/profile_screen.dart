                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  email,
                                  style: const TextStyle(color: Color(0xFF50606D), fontWeight: FontWeight.w500),
                                ),
                                const SizedBox(height: 12),
                                Row(
                                  children: [
                                    _buildBadge('Administrator', const Color(0xFFD1E2F1), const Color(0xFF00425E)),
                                  ],
                                ),
                              ],
                      ...
                      StreamBuilder<List>(
                        ...
                        builder: (context, prodSnapshot) {
                          ...
                          return Row(
                            children: [
                              Expanded(child: _buildStatItem('Items Tracked', '$count')),
                              const SizedBox(width: 16),
                              Expanded(child: _buildStatItem('System Status', 'Active')),
                            ],
                      ...
                      TextButton.icon(
                        ...
                        label: const Text(
                          'Sign Out',
                          style: TextStyle(color: Color(0xFFBA1A1A), fontWeight: FontWeight.bold, fontSize: 16),
                        ),
                      ...
                      const Text(
                        ...
                        style: TextStyle(fontSize: 11, color: Color(0xFF70787E), fontWeight: FontWeight.w500),
                      ),
  ...
  Widget _buildStatItem(String label, String value) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label.toUpperCase(), style: const TextStyle(fontSize: 9, fontWeight: FontWeight.w800, color: Color(0xFF50606D), letterSpacing: 1)),
          const SizedBox(height: 4),
          Text(value, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFF00425E))),
        ],
      ),
    );
  }

  Widget _buildMenuItem(IconData icon, String title, String subtitle, {bool hasBadge = false}) {
    return Container(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF191C1D))),
                Text(subtitle, style: const TextStyle(fontSize: 12, color: Color(0xFF50606D))),
              ],
            ),
          ),
          if (hasBadge)
